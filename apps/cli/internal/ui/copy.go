...
const (
	...
	ObservabilityTitle           = "Observability stack"
	ObservabilityDescription     = "Pick the generated observability story for this app."
	ObservabilityNoneLabel       = "🪶 No bundled stack"
	ObservabilityGrafanaOSSLabel = "📊 Grafana OSS"
